...
import com.cdcm.example.repository.PersonRepository;
...
public class PersonServiceImp implements PersonService{
    ...
    @Override
    public List<Person> getUsersByNameStartsWith(String name) {
    ...
    public Page<Person> search(String name, String minAge, String maxAge, String city, Pageable pageable) {
        ...
        if (minAge != null && maxAge != null) {
            criteria.add(Criteria.where("age").gt(minAge).lt(maxAge));
        } else if (minAge != null) {
            criteria.add(Criteria.where("age").gt(minAge));
        } else if (maxAge != null) {
            criteria.add(Criteria.where("age").lt(maxAge));
        }
